...
gantt
    ...
    section 项目准备
    可行性分析与 CASE 调研      :done,    p1, 2026-03-20, 1d
    过程模型与风险管理          :done,    p2, 2026-03-27, 1d

    section 建模与计划
    XP DevOps 活动图分析        :done,    p3, 2026-04-03, 1d
    甘特跟踪和组织结构分析       :done,    p4, 2026-04-10, 1d

    section 需求规格
    工作量估算和风险细化         :done,    p5, 2026-04-17, 1d
    SRS 初稿和静态建模           :done,    p6, 2026-05-08, 1d
    SRS 动态建模和完善           :done,    p7, 2026-05-15, 1d

    section 架构设计
    SAD 初稿                    :done,    p8, 2026-05-22, 1d
    SAD 完成                    :done,    p9, 2026-06-05, 1d

    section 设计评估
    设计原则和依赖注入分析       :done,    p10, 2026-06-12, 1d
```
